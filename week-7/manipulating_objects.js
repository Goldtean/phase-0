...
// What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  // The one I had the most trouble with was passing carson into terah.children. I wasn't getting that
  // I was replacing the object instead of passing in a new one. It doesn't work the same as arrays and
  // hashes in Ruby. I first added an array and passing in the different names, and didn't understand why
  // it wasn't working.
// How difficult was it to add and delete properties outside of the object itself?
  // It's easy if you know how to do it. It's a bit mind bending. Deleting is super easy, though. 
// What did you learn about manipulating objects in this challenge?
  // I learned how to add objects and add objects inside of objects. I also learned how to delete objects or
  // parts of objects.
